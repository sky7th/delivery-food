                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <h1 class="tw-h1"
                                                ...
                                                안녕하세요, 딜리버리 푸드 입니다.</h1>
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                            <span style="font-weight: 400;">저희 <strong>딜리버리 푸드</strong>에 가입해주셔서 감사합니다!</span><br/><br/><span
                                            ...
                                            <p class="tw-signoff"
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">딜리버리 푸드</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
