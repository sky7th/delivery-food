...
public class OptionRequestDto {
  ...
  public static Option toEntity(Long optionGroupId, OptionRequestDto requestDto) {
    return new Option(optionGroupId, requestDto.getName(), Money.wons(requestDto.getPrice()));
  }

  public static List<Option> toEntities(Long optionGroupId, List<OptionRequestDto> requestDto) {
    return requestDto.stream()
        .map(r -> OptionRequestDto.toEntity(optionGroupId, r))
        .collect(Collectors.toList());
  }
}
